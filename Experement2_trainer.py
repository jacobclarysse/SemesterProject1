...
for i in range(1, 51):
    ...
    filepath = "Experiment2/"+name+"-model-{epoch:02d}.hdf5"
    ...
    #save the network
    model.save("Experiment2/"+name+'.h5') ##Use load_model(file_path) to get weights and model back
